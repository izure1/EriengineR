module.exports = {
	cid: '{C6BD15A7-3159-430A-B0B5-E7ADF7482E5E}',
	version: '1.0.0',
	class: '대사',
	title: '독백을 말합니다',
	description: '{{출력내용}}(를)을 {{출력방식}} 말합니다. 필요하다면 음성 {{음성파일}}도 재생합니다. <br>다음 행동은 대사를 넘기거나 비우기 전까지 보류됩니다. <br><hr>출력 속도: {{출력속도v2}} / 출력 대기: {{출력대기v2}}',
	variables: {
		'출력내용': {
			text: '독백내용',
			type: 'text'
