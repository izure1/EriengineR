module.exports = {
	cid: '{9443d62c-8fd3-4585-845c-954ef544b2d2}',
	version: '1.0.0',
	class: '화면/효과',
	title: '화면에 페이드아웃 효과를 줍니다',
	description: '장소 {{장소명}}에 {{시간}}초를 거쳐 페이드아웃 효과를 줍니다. <br>{{색상명}} 색상의 {{효과명}}(를)을 {{편의성}} 줍니다. <br>중복될 수 없으며, 기존 효과는 즉시 사라집니다.<br><hr>슬라이드 방향: {{방향}}',
	variables: {
		'장소명': {
			text: '(플레이)',
			type: 'value',
