...
<script>
  ...
  // Methods
  import cancelConnecting from './methods/cancelConnecting'
  import createConnection from './methods/createConnection'
  import deleteConnection from './methods/deleteConnection'
  import createConnectionDone from './methods/createConnectionDone'
  import createScript from './methods/createScript'
  import copyScript from './methods/copyScript'
  import dropScript from './methods/dropScript'
  import focusScript from './methods/focusScript'
  import getScriptId from './methods/getScriptId'
  import getScriptData from './methods/getScriptData'
  import getOriginScript from './methods/getOriginScript'
  import getScriptTitle from './methods/getScriptTitle'
  import getMacroDescription from './methods/getMacroDescription'
  import modifyScript from './methods/modifyScript'
  import saveScript from './methods/saveScript'
  import setAxisAlertor from './methods/setAxisAlertor'
  import setConnectBox from './methods/setConnectBox'
  import setCursorInformation from './methods/setCursorInformation'
  import setDraggableBox from './methods/setDraggableBox'
  import setJsPlumbBox from './methods/setJsPlumbBox'
  import setZAxis from './methods/setZAxis'
  import watchDirectory from './methods/watchDirectory'
  import parseCommentToHTML from './methods/parseCommentToHTML'
  import isUnrunable from './methods/isUnrunable'
