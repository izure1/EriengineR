<template>
  <main>
    <div v-if="!project.template" class="project-setting-empty">
      <h2>프로젝트 세부 설정</h2>
      <ol>
    ...
    <div v-else class="project-setting">
      <dl>
        <dt>프로젝트 템플릿</dt>
        <dd style="color:orange">{{ project.template.name }}</dd>
        ...
        <dd>
          <input type="text" placeholder="이곳에 프로젝트의 고유명을 입력하세요" v-model="project.id" class="project-setting-needed">
        </dd>
